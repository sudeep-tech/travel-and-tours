@extends('layouts.frontend_layout')
    ...
    <div class="hero-wrap js-halfheight" style="background-image: url({{asset('uploads/images/hotel_details/'.@$ind_detail->image)}});">
								...
								<div class="destination">
									...
									<div class="text p-3">
										...
										<h3><a href="{{route('hotel_by_detail',@$ind_detail->slug)}}">{{ucwords(@$ind_detail->property_name)}}</a></h3>
				                                 ...
				                                 <p>Language spoken : {{ucwords(str_replace('_',' ',@$ind_detail->language_spoken))}}</p>
