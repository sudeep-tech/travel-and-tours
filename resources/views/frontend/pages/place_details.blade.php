              ...
              <div class="row">
                ...
                <!-- <div class="row"> -->
                    ...
                    <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                        ...
                        <h2>{{ucwords(@$place_details->title)}}</h2>
                        <p class="rate mb-5">
                            <span class="loc"><a href="#"><i class="icon-map"></i>{{@$place_details->district_id}}</a></span>
                            <span class="star">
                                    <i class="icon-star"></i>
                                    <i class="icon-star"></i>
                                    <i class="icon-star"></i>
                    ...
                    <div class="container hotel-single ftco-animate mb-5 mt-5">
                        <h4 class="mb-4"> Hotels Near by </h4>
                        <div class="row">
								...
								<div class="destination">
									...
									<div class="text p-3">
										<div class="d-flex">
                                            ...
                                            <div class="one">
												<h3><a href="{{route('tourpackage_by_detail',@$ind_detail->slug)}}">{{ucwords(@$ind_detail->guide)}}</a></h3>
											
                                            </div>
                                           
											<div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_detail->service_level))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_detail->age_requirement))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_detail->num_people))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_detail->travel_period))}}</span>
											</div>
										</div>
										<p>{!!@$ind_detail->description!!}</p>
										<p class="days"><span>{{@$ind_detail->district_id}}</span></p>
										<hr>
										<p class="bottom-area d-flex">
											<!-- <span><i class="icon-map-o"></i> San Franciso, CA</span>  -->
