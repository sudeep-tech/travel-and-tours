                ...
                <!-- <div class="row"> -->
                    <div class="col-md-12 ftco-animate">
                        <div class="single-slider owl-carousel">
                            <div class="item">
                                <div class="hotel-img" style="background-image: url({{asset('uploads/images/place_details/'.@$place_details->image)}});"></div>
                            </div>
                            <!-- <div class="item">
                    ...
                    <div class="col-md-12 hotel-single mt-4 mb-5 ftco-animate">
                        ...
                        <h2>{{ucwords(@$hotel_packages->property_name)}}</h2>
                        <p class="rate mb-5">
                            <span class="loc"><a href="#"><i class="icon-map"></i>{{@$hotel_packages->Floor_level}}</a></span>
                            <span class="star">
                                    <i class="icon-star"></i>
                                    <i class="icon-star"></i>
                                    <i class="icon-star"></i>
                                ...
                                <p>{!! @$hotel_packages->room_no!!}</p>
                                
                                <div class="d-md-flex mt-5 mb-5">
                                   {!! @$hotel_packages->free_wifi !!}
                                </div>
          	...
          	<div class="row">
				  @if(isset($hotel_details->hotel_packages[0]->id))
					...
					<div class="col-sm col-md-6 col-lg-4 ftco-animate">
								<div class="destination">
									<a href="{{route('hotelpackage_by_detail',@$ind_hotel_package->slug)}}" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url({{asset('uploads/images/place_details/'.@$ind_hotel_package->image)}});">
									...
									<div class="text p-3">
										<div class="d-flex">
											<div class="one">
												<h3><a href="{{route('hotelpackage_by_detail',@$ind_hotel_package->slug)}}">{{ucwords(@$ind_hotel_package->Title)}}</a></h3>
											
                                            </div>
                                            
                                           
											<div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_hotel_package->service_level))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_hotel_package->age_requirement))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_hotel_package->num_people))}}</span>
                                            </div>
                                            <div class="two">
												<span class="price" style="font-size:14px;">{{ucwords(str_replace('_',' ',@$ind_hotel_package->travel_period))}}</span>
											</div>
										</div>
										<p>{!!@$ind_hotel_package->description!!}</p>
										<p class="days"><span>{{@$ind_hotel_package->district_id}}</span></p>
										<hr>
										<p class="bottom-area d-flex">
											<!-- <span><i class="icon-map-o"></i> San Franciso, CA</span>  -->
											<span class="ml-auto"><a href="{{route('hotelpackage_by_detail',@$ind_detail->slug)}}">Discover</a></span>
										</p>
									</div>
								</div>
							</div>
